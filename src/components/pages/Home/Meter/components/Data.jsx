...
function Data({ isActive }) {
  ...
  return (
    <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 md:p-5 md:p-10 lg:p-20 gap-0 md:gap-5 mt-20 md:mt-20">
      ...
      <div className="text-center relative ">
        ...
        <div className="absolute mt-[-15%] md:top-1/2 transform -translate-y-1/2 m-auto w-full   flex justify-center z-0">
