    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          ...
          divRef2.current.classList.remove("active");
        }
      });
    }, options);
...
>
  ...
  <div className="absolute w-[90%]  h-full p-2 z-0 mt-[-0.5%]" >
    <div
    
      className="flex gap-80 justify-center w-full"
    >
      <div   ref={divRef} className="justify-center p-5 md:p-2 lg:p-10 xl:p-0 floating">
        <img className="m-auto" src="/images/solutions/Web2.svg" width={250} height={250}/>
      </div>
      <div   ref={divRef2} className="justify-center p-5 md:p-2 lg:p-10 xl:p-0 floating2">
